...
import 'package:tms/data/appException.dart';
import 'package:tms/data/network/baseApiServices.dart';
...
class NetworkApiServices extends BaseApiServices {
  ...
  Future formDataPostServices(dynamic url, Map<String, String> data,
      Map<String, String> headers, String? filekey, String? filePath,
      {String? filekey2, String? filePath2}) async {
    ...
    try {
      ...
      if (filePath2 != null && filePath2.isNotEmpty) {
        request.files.add(await http.MultipartFile.fromPath(
            filekey2.toString(), filePath2.toString()));
      }
